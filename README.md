...
###### Create
```
aws cloudformation --profile accord create-stack --stack-name mytemplate --template-body file:///Users/jamliu1/code/learn/lit/awslab1/mytemplate.yml --parameter ParameterKey=EnvironmentName,ParameterValue=jamesliu
```
...
aws cloudformation list-stacks --stack-status-filter CREATE_COMPLETE
{
    "StackSummaries": [
        {
            "StackId": "arn:aws:cloudformation:eu-west-2:598559435893:stack/mytemplate/558bb8d0-ba58-11ea-9d9a-02949b77ae4a",
            "StackName": "mytemplate",
...
###### Describe:
```
aws cloudformation describe-stacks --stack-name mytemplate --output yaml
Stacks:
- CreationTime: '2020-06-29T22:36:33.312000+00:00'
...
- EventId: fbba9960-ba58-11ea-a65d-029d9e7b7264
  LogicalResourceId: mytemplate
  PhysicalResourceId: arn:aws:cloudformation:eu-west-2:598559435893:stack/mytemplate/558bb8d0-ba58-11ea-9d9a-02949b77ae4a
...
###### List Resources:
```
aws cloudformation list-stack-resources --stack-name mytemplate
{
...
aws cloudformation validate-template --template-body file:///Users/jamliu1/code/learn/lit/awslab1/mytemplate.yml --output yaml
Description: This template deploys a VPC, with a pair of public and private subnets
  spread across two Availability Zones. It deploys an internet gateway, with a default
  route on the public subnets. It deploys a pair of NAT gateways (one in each AZ),
  and default routes for them in the private subnets.
